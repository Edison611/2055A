...
void auton_skills() {
    ...
    chassis.moveTo(20, 10, -90, 1750);
    turnTo(-115);
    wingB.set_value(false);
    // turnTo(0);
    // wingB.set_value(true);
    chassis.moveTo(2, -20, 0, 2250, false, false, 0, 0.6);
...
void offense_auton_midrush_new() {
    chassis.setPose(-43.5, 57, 158);
    setIntake(127);
    chassis.moveTo(-24, 7, 158, 1000);
}
