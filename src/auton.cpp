...
void offense_auton_safe() {
    ...
    wingF.set_value(true);
    setIntake(-127);
    chassis.moveTo(68, -7, 90, 1500);
    chassis.moveTo(60, -7, 90, 400);
    setIntake(0);
