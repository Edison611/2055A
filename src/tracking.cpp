...
std::string getAllPower() {
	std::string left = std::to_string(driveLB.get_power()) + ", " + std::to_string(driveLM.get_power()) 
	+ ", " + std::to_string(driveLF.get_power());
	std::string right = std::to_string(driveRB.get_power()) + ", " + std::to_string(driveRM.get_power()) 
	+ ", " + std::to_string(driveRF.get_power());
...
std::string getAllVelocity() {
	std::string left = std::to_string(driveLB.get_actual_velocity()) + ", " + std::to_string(driveLM.get_actual_velocity()) 
	+ ", " + std::to_string(driveLF.get_actual_velocity());
	std::string right = std::to_string(driveRB.get_actual_velocity()) + ", " + std::to_string(driveRM.get_actual_velocity()) 
	+ ", " + std::to_string(driveRF.get_actual_velocity());
...
std::string getAllVoltage() {
	std::string left = std::to_string(driveLB.get_voltage()) + ", " + std::to_string(driveLM.get_voltage()) 
	+ ", " + std::to_string(driveLF.get_voltage());
	std::string right = std::to_string(driveRB.get_voltage()) + ", " + std::to_string(driveRM.get_voltage()) 
	+ ", " + std::to_string(driveRF.get_voltage());
